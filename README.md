...
```shell
docker run -d --privileged --volume=/sys/fs/cgroup:/sys/fs/cgroup:ro almalinux8-systemd-ansible:latest ansible --version
```
...
platforms:
  - name: instance
    image: "chzerv/${IMAGE:-almalinux8}-systemd-ansible:latest"
